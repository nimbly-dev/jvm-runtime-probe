...
const { buildRecipeExecutionPlan } = require("@tools-core/recipe_execution_plan.util");
...
test("regression plan does not include probe calls", () => {
  ...
  assert.equal(plan.selectedMode, "regression");
